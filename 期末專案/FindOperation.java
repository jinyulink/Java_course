        ...
        if(number == 1){       	
            ...
            for (int i = 0; i < booklist.getBooks().size(); i++) {
                ...
                if(book.getName().equals(name)){
                    ...
                    JLabel ll1 = new JLabel(book.getName());
                    ll1.setFont(new Font("MV Boil",Font.BOLD,15));
                    JLabel ll2 = new JLabel(book.getAuthor());
                    ll2.setFont(new Font("MV Boil",Font.BOLD,15));
                    JLabel ll3 = new JLabel(book.getPublish());
                    ll3.setFont(new Font("MV Boil",Font.BOLD,15));
                    JLabel ll4 = new JLabel(book.getType());
                    ll4.setFont(new Font("MV Boil",Font.BOLD,15));
                    JLabel ll5 = new JLabel(String.valueOf(book.getBorrow()));
                    ll5.setFont(new Font("MV Boil",Font.BOLD,15));
                    JLabel ll6 = new JLabel(String.valueOf(book.getSearch()));
