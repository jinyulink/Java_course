...
public class Test { 
	...
	public static void main(String[] args) throws ParseException {
        Member.addStudent(new Student("程子芸","002","002"));
		Member.addStudent(new Student("曾筱媛","007","007"));
		Member.addStudent(new Student("林晉宇","518","518"));
		Member.addStudent(new Student("林俊仰","601","601"));
		DateFormat dateFormat1 = new SimpleDateFormat("yyyy-MM-dd");
		Date myDate1 = dateFormat1.parse("2022-05-30");
		Member.getStlist().get(0).addRecord(new Record("林晉宇","三國演義",myDate1,null,false,0));
        System();
   }
